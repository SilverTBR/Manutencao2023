...
public class ClienteDAOTest {
    ...
    public void cpfUnicoTest(){        
       setCaminhos();
        try{ 
            ...
            controle.getCliente().setCPF("111.111.111-11");
            controle.getCliente().setBairro("Bairro Teste");
             controle.getCliente().setContato(Long.parseLong("18981238742"));
            controle.inserirClientes();
    ...
    @Test
    public void telefoneCadastradoTest(){
    ...
    @Test
    public void cpfNaoCadastradoTest(){
        ...
        controle = criaClienteGenerico();
        controle.getCliente().setCPF("111.121.121-11");
        controle.inserirClientes();
        controle.consultarTodosCliente();

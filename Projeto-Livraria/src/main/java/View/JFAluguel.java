...
public final class JFAluguel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jBClientes1.setBackground(new java.awt.Color(204, 204, 204));
        jBClientes1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jBClientes1.setText("Cadastrar ADMs");
        jBClientes1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jBClientes1MouseClicked(evt);
            }
        });
                ...
                .addGroup(jPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jBClientes1, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void jBDevolucaoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBDevolucaoMouseClicked
            controle.devolucaoAluguel(Integer.parseInt(jTResult.getModel().getValueAt(jTResult.getSelectedRow(), 0).toString()));
            atualizarTabelaTudo();
            jTLivros.setModel(controle.getLivroModel("%%"));
    ...
    private void jBClientes1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBClientes1MouseClicked
        // TODO add your handling code here:
        controle.desconectar();
        JFCadastro jfcad = new JFCadastro();
        jfcad.setVisible(true);
        dispose();  
    }//GEN-LAST:event_jBClientes1MouseClicked
